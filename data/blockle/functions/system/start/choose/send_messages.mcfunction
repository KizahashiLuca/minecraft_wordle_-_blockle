...
tellraw @a ["",{"text":"    ","color":"white","bold":false,"italic":false},{"selector":"@p[predicate=blockle:team/team_a]","bold":false,"italic":false}]
tellraw @a ["",{"text":"    ","color":"white","bold":false,"italic":false},{"selector":"@p[predicate=blockle:team/team_b]","bold":false,"italic":false}]
tellraw @a ["",{"text":"    ","color":"white","bold":false,"italic":false},{"selector":"@p[predicate=blockle:team/team_c]","bold":false,"italic":false}]
tellraw @a ["",{"text":"    ","color":"white","bold":false,"italic":false},{"selector":"@p[predicate=blockle:team/team_d]","bold":false,"italic":false}]
